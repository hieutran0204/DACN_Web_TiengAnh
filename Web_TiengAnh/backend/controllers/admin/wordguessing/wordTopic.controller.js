...
class WordTopicAdminController {
  ...
  try {
    ...
    const data = {
      name: req.body.name || req.body.tenTopic || req.body.title || req.body.TenTopic,
      description: req.body.description || req.body.moTa || req.body.mota || ""
    };
  ...
  async update(req, res) {
    try {
      const updated = await wordTopicService.updateTopic(req.params.id, req.body);
      res.status(200).json({ 
        success: true, 
