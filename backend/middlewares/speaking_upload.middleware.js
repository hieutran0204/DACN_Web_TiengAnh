...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    ...
    const uploadPath = path.join(basePath, "uploads", "speaking", "image");
...
const speaking_upload = (req, res, next) => {
  upload.single("image")(req, res, (err) => {
    ...
    if (req.file) {
      req.body.image = `/uploads/speaking/image/${req.file.filename}`;
...
module.exports = speaking_upload;
