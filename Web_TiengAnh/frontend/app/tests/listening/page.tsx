        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <div className="flex justify-center mb-8">
              <div className="p-8 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {exams.length === 0 ? (
              ...
              exams.map((exam) => (
                <Link href={`/tests/listening/exam/${exam._id}`} key={exam._id}>
                  <Card className="group h-full hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border-2 hover:border-primary/50 cursor-pointer overflow-hidden">
                    ...
                    <CardHeader className="pb-4">
                      ...
                      <CardTitle className="text-2xl font-bold text-foreground group-hover:text-primary transition line-clamp-2">
                        {exam.title}
                      </CardTitle>
                    ...
                    <CardContent className="space-y-5">
                      ...
                      <Button className="w-full h-12 text-lg font-semibold bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white shadow-lg group-hover:scale-105 transition-all">
                        <PlayCircle className="w-5 h-5 mr-2" />
                        Bắt Đầu Nghe Ngay
                      </Button>
                    </CardContent>
          ...
          {/* Stats Banner */}
          {exams.length > 0 && (
            <div className="bg-gradient-to-r from-blue-500/10 via-cyan-500/10 to-purple-600/10 rounded-3xl p-12 text-center border border-primary/20">
