...
const questionController = require("../../controllers/admin/create/question/TOEIC/writing/CRUD_writingTOEIC.controller");
const examController = require("../../controllers/admin/create/exam/TOEIC/writing/CRUD_ExamPart_Writing.controller");
...
const validateRequest = (req, res, next) => {
  ...
  if (![8, 9, 10].includes(parseInt(part))) {
    return res
      .status(400)
      .json({ error: "Part không hợp lệ. Chỉ chấp nhận 8, 9, hoặc 10." });
  }
  next();
};
