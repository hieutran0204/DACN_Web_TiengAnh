...
const slides = [
  {
    ...
    title: "Master English Pronunciation",
    description:
      "Improve your speaking skills with interactive pronunciation exercises",
    image: "/english-classroom-students-learning.jpg",
    cta: "Start Speaking",
  },
  {
  ...
  },
  {
    ...
    title: "Ace Your English Tests",
    description:
      "Practice with authentic test questions and get instant feedback",
    image: "/students-taking-exam-test.jpg",
    cta: "Take a Test",
  },
];
      ...
      <div className="relative h-96 md:h-[500px]">
        {slides.map((slide, index) => (
          <div
            ...
            />
            <div className="absolute inset-0 flex flex-col justify-center items-start px-8 md:px-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white drop-shadow-lg mb-4 max-w-2xl">
                {slide.title}
              </h2>
              <p className="text-lg md:text-xl text-white drop-shadow-md mb-8 max-w-xl">
                {slide.description}
              </p>
              <Button className="bg-primary hover:bg-accent text-primary-foreground text-lg px-8 py-3">
                {slide.cta}
