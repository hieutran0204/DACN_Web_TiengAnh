...
const hiddenWordController = require("../../controllers/admin/create/game/hiddenWord.controller");
...
router.post(
  "/create",
  upload.single("image"),
  hiddenWordController.createHiddenWord
);
router.get("/list", hiddenWordController.getHiddenWordList);
...
router.post(
  "/update/:id",
  upload.single("image"),
  hiddenWordController.updateHiddenWord
);
