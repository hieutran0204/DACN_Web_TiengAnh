...
const controller = require("../../controllers/admin/create/game/transcription.controller");
const uploadMulti = require("../../middlewares/uploadMulti.middleware");

router.get("/create", (req, res) =>
  res.render("admin/pages/TOEIC/transcription-create")
);
router.post(
  "/create",
  uploadMulti.fields([{ name: "audio", maxCount: 1 }]),
